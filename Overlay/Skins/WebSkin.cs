...
internal sealed class WebSkin : IOverlaySkin
{
    ...
    public WebSkin()
    {
        ...
        _pillDragHandle = new TextBlock { Text = "⋮⋮", Foreground = TextBrush, FontFamily = WebFont, FontSize = 11, VerticalAlignment = VerticalAlignment.Center, Margin = new Thickness(0, 0, 10, 0), Cursor = new Cursor(StandardCursorType.SizeAll) };
